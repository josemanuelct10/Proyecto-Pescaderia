    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{route("clientes.inicio")}}">Inicio</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('clientes.pescado')}}">Pescado</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('clientes.marisco')}}">Marisco</a>
          </li>
        </ul>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="{{route('facturas')}}">Facturas</a></li>
